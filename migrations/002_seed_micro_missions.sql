...
VALUES
('MM-E001', 'The Whispering Flame', 'A faint voice calls from the eternal brazier. Listen to its wisdom.', 'EASY', 120, 5, 10, 15, 5, 10, 10, 20, 5.00, 'The flames flicker as you approach the ancient brazier. A voice, barely audible, speaks of forgotten truths...', 0, TRUE),
('MM-E002', 'Ember Gathering', 'Collect scattered embers in the Ashen Fields before they fade.', 'EASY', 120, 5, 8, 12, 3, 8, 8, 15, 3.00, 'Glowing embers dot the ashen landscape. Quick - gather them before they return to the void!', 0, TRUE),
('MM-E003', 'Patrol the Perimeter', 'A routine patrol around the portal''s edge. Stay vigilant.', 'EASY', 120, 5, 10, 15, 5, 10, 10, 20, 5.00, 'You take your position at the portal''s edge. The mists swirl with unknown dangers...', 0, TRUE),
('MM-E004', 'Rune Meditation', 'Meditate before the ancient rune stone to absorb its power.', 'EASY', 120, 3, 5, 10, 2, 5, 5, 12, 2.00, 'The rune stone hums with ancient energy. Close your eyes and let its power flow through you...', 0, TRUE),
('MM-E005', 'Forge Apprentice', 'Assist the blacksmith with simple tasks at the Eternal Forge.', 'EASY', 120, 5, 8, 12, 3, 8, 8, 15, 3.00, 'The heat of the forge washes over you. The blacksmith nods - there is work to be done.', 0, TRUE)
...
INSERT INTO micro_missions (id, name, description, difficulty, duration_seconds, energy_cost, pyre_reward_min, pyre_reward_max, xp_reward_min, xp_reward_max, ember_reward_min, ember_reward_max, aura_chance, narrative_intro, cooldown_minutes, is_active)
VALUES
('MM-M001', 'Void Echoes Investigation', 'Strange sounds emanate from the void. Investigate their source.', 'MEDIUM', 240, 10, 20, 30, 10, 20, 25, 40, 10.00, 'The void whispers secrets that mortal ears were not meant to hear. Do you dare listen?', 5, TRUE),
('MM-M002', 'Guild Messenger', 'Deliver an urgent message between guild outposts.', 'MEDIUM', 240, 8, 15, 25, 8, 15, 20, 35, 8.00, 'A sealed scroll bears the mark of your guild. Time is of the essence - deliver it swiftly!', 3, TRUE),
('MM-M003', 'Ash Beast Tracking', 'Track the movements of ash beasts near the settlement.', 'MEDIUM', 240, 10, 20, 30, 10, 20, 25, 40, 10.00, 'Strange tracks mark the ashen ground. The beasts are near - proceed with caution.', 5, TRUE),
('MM-M004', 'Crystal Harvesting', 'Harvest resonance crystals from the Singing Caves.', 'MEDIUM', 240, 8, 15, 25, 8, 15, 20, 35, 8.00, 'The caves sing with crystal harmonies. Extract the resonant gems carefully...', 3, TRUE),
('MM-M005', 'Spirit Communion', 'Commune with the spirits of fallen emissaries.', 'MEDIUM', 240, 10, 20, 30, 10, 20, 25, 40, 12.00, 'The veil between worlds grows thin. The spirits of the fallen seek to share their wisdom...', 5, TRUE)
ON CONFLICT (id) DO UPDATE SET
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    difficulty = EXCLUDED.difficulty,
